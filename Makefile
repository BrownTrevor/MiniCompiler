...
MiniCompiler.class : antlr.generated ${FILES}
	$(JAVAC) -cp ${CLASSPATH}:$(CLASSPATH_MOD) *.java ast/*.java cfg/*.java llvm/*.java ssa/*.java globals/*.java
...
clean:
	\rm -rf *generated* ${GENERATED} *.class ast/*.class cfg/*.class llvm/*.class ssa/*.class globals/*.class
